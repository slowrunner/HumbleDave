...
GPG.WHEEL_DIAMETER = 67.0
GPG.WHEEL_BASE_WIDTH = 112.0
GPG.WHEEL_BASE_CIRCUMFERENCE = GPG.WHEEL_BASE_WIDTH * math.pi # The circumference of the circle the wheels will trace while turning (mm)
GPG.WHEEL_CIRCUMFERENCE      = GPG.WHEEL_DIAMETER   * math.pi # The circumference of the wheels (mm)
GPG.ENCODER_TICKS_PER_ROTATION = 16  # MAGIC NUMBER TO MAKE NEW GOPIGO3 KIT WORK
GPG.MOTOR_TICKS_PER_DEGREE = ((GPG.MOTOR_GEAR_RATIO * GPG.ENCODER_TICKS_PER_ROTATION) / 360.0) # encoder ticks per output shaft rotation degree
...
try:
    TurnDegrees(90, 90)   # turn 90 degrees to the right, at a wheel speed of 100 degrees per second
    time.sleep(7)
    TurnDegrees(-180, 90) # turn 180 degrees to the left, at a wheel speed of 100 degrees per second
    time.sleep(8)
    TurnDegrees(90, 90)   # turn 90 degrees to the right, at a wheel speed of 100 degrees per second
    time.sleep(3)
    GPG.reset_all()
