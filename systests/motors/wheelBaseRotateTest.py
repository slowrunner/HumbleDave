...
#          09-30-2018 with batteries installed inside ROSbot's body, and new Pololu 1" castor ball
...
if ROSbot:
    ...
    myconfig.setParameters(egpg,verbose=True)   # configure custom wheel dia, wheel base, ticks per revolution
    ps.rotate_servo(90)
    time.sleep(0.5)
...
while True:
    ...
    if ROSbot:  runLog.logger.info("Exit")
