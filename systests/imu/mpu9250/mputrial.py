...
class MPU9255(Thread):
    ...
    def initMPU(self):
        ...
        if PRINT: print("WHO_AM_I: ",hex(whoAmI))
    ...
    def calibrate(self):
        ...
        if PRINT: print("AxCal: ", AxCal)
        if PRINT: print("AyCal: ", AyCal)
        if PRINT: print("AzCal: ", AzCal)
        ...
        GyCal = y / 131.0
        GzCal = z / 131.0
        if PRINT: print("GxCal: ", GxCal)
        if PRINT: print("GyCal: ", GyCal)
        if PRINT: print("GzCal: ", GzCal)
    ...
    def calibrateMag(self):
        ...
        if PRINT: print("MxCal: ", MxCal)
        if PRINT: print("MyCal: ", MyCal)
        if PRINT: print("MzCal: ", MzCal)
...
def main():
    ...
    for i in readings:
        if PRINT: print_reading(i[0],i[1],i[2],i[3],i[4])
